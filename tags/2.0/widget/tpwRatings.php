...
class tpwRatings {
    ...
    public function renderRatings() {
        ...
        $companyName = $ratingsData->companies_widget->name;
        $averageRating = $ratingsData->companies_widget->average_rating;
        $ratingsCount = $ratingsData->companies_widget->rating_count;
        $widgetCode = $ratingsData->companies_widget->widget_code;
